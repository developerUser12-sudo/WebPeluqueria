...
@section('content')
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <input id="name" class="block mt-1 w-full rounded-2 text-dark" type="text" name="name" required autofocus>
        ...
        <div class="mt-4">
            ...
            <input id="password_confirmation" class="block mt-1 w-full rounded-2 text-dark" type="password"
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox"
                    ...
                    required>
                <span class="ms-2 text-light">Acepto la <a href="/politica-de-privacidad">política de privacidad</a> y el <a
                        href="/aviso-legal">aviso legal</a></span>
            </label>
        </div>
