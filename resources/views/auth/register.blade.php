        ...
        <div class=" bg-black p-5 rounded-4 ">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div>
                    ...
                    <input id="name" class="block mt-1 w-full rounded-2" type="text" name="name"  required
                        autofocus>
                    <x-input-error :messages="$errors->get('name')" class="mt-2" />
                </div>
                <div class="mt-4">
                    <label for="surname" class="text-light">Apellidos</label>
                    <input id="surname" class="block mt-1 w-full rounded-2" type="text" name="surname"  required
                        autofocus>
                    <x-input-error :messages="$errors->get('surname')" class="mt-2" />
                </div>
                <div class="mt-4">
                    <label for="phone" class="text-light">Número de teléfono</label>
                    <input id="phone" class="block mt-1 w-full rounded-2" type="text" name="phone"  required
                        autofocus>
